  ...
  return (
    <main className="flex-1 p-4 overflow-y-auto">
      <div className="flex items-center justify-between mb-4">
        ...
        <p className="text-xs text-secondary mt-2">Last Update: 7 day(s) ago</p>
      </div>
      {activeTab === "Overview" ? (
        <>
            ...
            <div className="w-1/3">
              ...
              {[
                ...
                <div key={index} className="flex items-center space-x-2 mb-2">
                  <div className="text-sm font-medium bg-red-100 px-2 py-1 rounded-md border border-red-600">{item.date}</div>
                          ...
                          {[
                            {
                              ...
                              value: item.address_information.shipping_street,
                            },
                            {
                              label: "Shipping City",
                            ...
                            },
                            {
                              ...
                              value: item.address_information.shipping_state,
                            },
                            {
                              label: "Shipping Code",
                            ...
                            },
                            {
                              ...
                              value: item.address_information.shipping_country,
                            },
                          ].map((item, index) => (
                            <div key={index} className="flex items-center my-4">
                              <p className="text-secondary text-right mr-12 min-w-[160px] text-sm">
                    ...
                    <div className="px-6 py-2 rounded-lg  mb-8">
                      ...
                      <div className="flex items-center ">
                        ...
                        <p className="font-medium text-primary text-sm">
                          King is a multinational contract manufacturing company
                          with its headquarters in Baltimore, United States.
                        </p>
                      </div>
                    </div>
